...
(i) $r_{Lt-1}>\beta r_{St-1}+ \mu$ means $r_{Lt}$ is too high and that we'll move back. 

* The (expected) change in period $t$ in the $R_{Lt}$ direction is: $-\alpha_L(r_{Lt-1}-\beta_{} r_{St-1}-\mu) + a_{1,22}\Delta r_{Lt-1}$ and in the $r_{St}$ direction is: $a_{1,12}\Delta r_{Lt-1}$

* The (expected) change in period $t+1$ in the $R_{Lt}$ direction is: 

- $-\alpha_L(r_{Lt}-\beta_{} r_{St-1}-\mu) +a_{1,22}\Delta r_{Lt}+ a_{2,22}\Delta r_{Lt-1}$  

-In the the $r_{St}$ direction is: $a_{1,12}\Delta r_{Lt-1}$
